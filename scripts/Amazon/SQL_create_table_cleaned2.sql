/*
==================================================================================
DDL Scripts: create table Amazon products sales data cleaned2

==================================================================================
Script purpose:
	This script creates table in amazon schema by dropping existing table if
	they already exist.
	Run this scripts to re-define DDL structure of cleaned2 table
==================================================================================
*/

IF OBJECT_ID ('amazon.amazon_sales_data_cleaned2', 'U') IS NOT NULL
DROP TABLE amazon.amazon_sales_data_cleaned2;
CREATE TABLE amazon.amazon_sales_data_cleaned2 (
	product_key INT,
